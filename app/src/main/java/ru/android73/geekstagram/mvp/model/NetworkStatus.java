...
public class NetworkStatus
{
    ...
    {
        return Settings.Global.getInt(GeekstagramApp.getInstance().getContentResolver(),
                Settings.Global.AIRPLANE_MODE_ON, 0) != 0;
    }

    public static Status getStatus() {
        ConnectivityManager cm = (ConnectivityManager) GeekstagramApp.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
